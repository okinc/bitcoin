...
void SyncWithWallets(const CTransaction& tx, const CBlock* pblock = NULL,  CNode *pfrom = NULL,  bool fConflicted = false);
...
struct CMainSignals {
    ...
    boost::signals2::signal<void (const CTransaction &, const CBlock *, CNode *, bool)> SyncTransaction;
